...
module.exports = {
    data: new ContextMenuCommandBuilder()
        .setName("Timeout 1d")
        .setNameLocalizations(commandMeta.timeout?.timeout_1d || {})
    ...
    async execute(bot, interaction, funcs, settings, logger, t) {
        ...
        const reason = tS('commands:timeout.reason_quick', { duration: `1 ${tS('commands:timeout.unit_day')}` });
        ...
        try {
                ...
                .addSectionComponents(
                    new SectionBuilder()
                        ...
                        .addTextDisplayComponents(
                            ...
                            new TextDisplayBuilder().setContent(t('commands:timeout.success_desc', { user: user.tag, duration: `1 ${t('commands:timeout.unit_day')}` }))
                        )
                )
            ...
            logger.error("Error executing quick timeout 1d:", error);
            return interaction.reply({
