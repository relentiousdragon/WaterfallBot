...
module.exports = {
    data: new ContextMenuCommandBuilder()
        .setName("Timeout 1m")
        .setNameLocalizations(commandMeta.timeout?.timeout_1m || {})
    ...
    async execute(bot, interaction, funcs, settings, logger, t) {
        ...
        const reason = tS('commands:timeout.reason_quick', { duration: `1 ${tS('commands:timeout.unit_minute')}` });
        ...
        try {
                ...
                .addSectionComponents(
                    new SectionBuilder()
                        ...
                        .addTextDisplayComponents(
                            ...
                            new TextDisplayBuilder().setContent(t('commands:timeout.success_desc', { user: user.tag, duration: `1 ${t('commands:timeout.unit_minute')}` }))
                        )
                )
            ...
            logger.error("Error executing quick timeout 1m:", error);
            return interaction.reply({
    ...
    help: {
        name: "timeout1m",
        description: "Timeout a user for 1 minute",
        category: "Moderation",
